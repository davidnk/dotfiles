...
nnoremap  gc "zyiw:call ScratchBuffer():read !python ~/.vim/vim_helpers/get_children.py z
nnoremap  gr "zyiw:call ScratchBuffer():read !python ~/.vim/vim_helpers/get_references.py z
nnoremap  Q :mksession! ~/.vim/vim_sessions/prev_closed.vim:qa
nnoremap  q :q
...
silent only
cd ~/Documents/pgdev/pg/gotham
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +141 PGServer/server-src/com/palantir/nexus/db/AbstractDataSourcePR.java
badd +75 PGServer/server-src/com/palantir/nexus/db/DataSourcePR.java
badd +37 PGServer/server-src/com/palantir/nexus/db/LegacyDataSourceStore.java
badd +12 PGServer/server-src/com/palantir/nexus/db/DataSourceStore.java
badd +408 PGServer/buildlib/vendor/cache/gems/bundler-1.2.1/lib/bundler/cli.rb
badd +15 ~/Documents/pgdev/pt/ptdatabase/src/com/palantir/nexus/db/sql/AgnosticLightResultSet.java
badd +5 ~/Documents/pgdev/pt/commons-api/src/com/palantir/common/base/BatchingVisitable.java
badd +10 ~/Documents/pgdev/pt/ptdatabase/src/com/palantir/nexus/db/sql/AgnosticLightResultRow.java
badd +21 ~/Documents/pgdev/pt/commons-api/src/com/palantir/common/base/BatchingVisitableFromIterable.java
badd +15 ~/Documents/pgdev/pt/commons-api/src/com/palantir/common/base/AbstractBatchingVisitable.java
badd +187 ~/Documents/pgdev/pg/gotham/PGDatabaseConnection/src/com/palantir/nexus/db/sql/SQLString.java
badd +18 ~/Documents/pgdev/pg/gotham/PGServer/buildlib/vendor/cache/gems/buildlib-1.2.0.101/lib/buildlib/super.rb
badd +158 ~/.vimrc
badd +60 ~/Documents/pgdev/pg/gotham/PGServer/server-src/com/palantir/nexus/db/SharedDataSourceBackend.java
badd +28 ~/Documents/pgdev/pg/gotham/PGServer/server-src/com/palantir/nexus/db/DataSourceBackend.java
badd +230 ~/Documents/pgdev/pg/gotham/PGClient/i18n-src/com/palantir/i18n/xliff/jaxb/MtypeValueList.java
args PGServer/server-src/com/palantir/nexus/db/AbstractDataSourcePR.java
edit PGServer/server-src/com/palantir/nexus/db/LegacyDataSourceStore.java
...
549
normal! zo
let s:l = 37 - ((28 * winheight(0) + 17) / 35)
...
wincmd w
argglobal
edit PGServer/server-src/com/palantir/nexus/db/DataSourcePR.java
inoreabbr <buffer> logger logger=eclim#java#logging#LoggingInit("logger")
inoreabbr <buffer> log log=eclim#java#logging#LoggingInit("log")
setlocal keymap=
setlocal noarabic
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 75 - ((9 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
75
...
wincmd w
argglobal
edit PGServer/server-src/com/palantir/nexus/db/AbstractDataSourcePR.java
...
375
normal! zo
let s:l = 141 - ((38 * winheight(0) + 35) / 71)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
141
