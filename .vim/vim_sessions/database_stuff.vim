...
set shortmess=aoO
badd +0 pg/gotham/PGServer/dist/sql/postgres-schema.sql
badd +0 pt/ptdatabase/src/com/palantir/nexus/db/sql/AgnosticLightResultRow.java
badd +0 pt/ptdatabase/src/com/palantir/nexus/db/sql/AgnosticLightResultSet.java
silent! argdel *
edit pt/ptdatabase/src/com/palantir/nexus/db/sql/AgnosticLightResultRow.java
...
wincmd w
argglobal
edit pt/ptdatabase/src/com/palantir/nexus/db/sql/AgnosticLightResultSet.java
inoreabbr <buffer> logger logger=eclim#java#logging#LoggingInit("logger")
inoreabbr <buffer> log log=eclim#java#logging#LoggingInit("log")
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
edit pg/gotham/PGServer/dist/sql/postgres-schema.sql
let s:cpo_save=&cpo
set cpo&vim
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 1081 - ((9 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1081
