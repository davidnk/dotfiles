...
set shortmess=aoO
badd +0 pg/gotham/PGServer/server-src/com/palantir/nexus/db/AbstractDataSourcePR.java
badd +0 pg/gotham/PGServer/server-src/com/palantir/nexus/objectstore/api/ObjectDataEventBackend.java
badd +0 pg/gotham/PGServer/server-src/com/palantir/nexus/objectstore/legacy/LegacyObjectDataEventPR.java
badd +0 pg/gotham/PGClient/shared-src/com/palantir/dataservices/DataSourceUtils.java
badd +0 pg/gotham/PGServer/server-src/com/palantir/nexus/db/LegacyDataSourceStore.java
badd +0 pg/gotham/PGServer/server-src/com/palantir/nexus/db/DataSourceStore.java
badd +0 pg/gotham/PGServer/server-src/com/palantir/nexus/db/SharedDataSourceBackend.java
badd +0 pg/gotham/PGServer/server-src/com/palantir/nexus/db/DataSourceBackend.java
silent! argdel *
edit pg/gotham/PGServer/server-src/com/palantir/nexus/objectstore/api/ObjectDataEventBackend.java
...
let s:l = 179 - ((5 * winheight(0) + 6) / 12)
...
wincmd w
argglobal
edit pg/gotham/PGServer/server-src/com/palantir/nexus/objectstore/legacy/LegacyObjectDataEventPR.java
inoreabbr <buffer> logger logger=eclim#java#logging#LoggingInit("logger")
inoreabbr <buffer> log log=eclim#java#logging#LoggingInit("log")
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
edit pg/gotham/PGClient/shared-src/com/palantir/dataservices/DataSourceUtils.java
inoreabbr <buffer> logger logger=eclim#java#logging#LoggingInit("logger")
inoreabbr <buffer> log log=eclim#java#logging#LoggingInit("log")
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
edit pg/gotham/PGServer/server-src/com/palantir/nexus/db/LegacyDataSourceStore.java
inoreabbr <buffer> logger logger=eclim#java#logging#LoggingInit("logger")
inoreabbr <buffer> log log=eclim#java#logging#LoggingInit("log")
setlocal keymap=
setlocal noarabic
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 328 - ((5 * winheight(0) + 6) / 12)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
328
...
wincmd w
argglobal
edit pg/gotham/PGServer/server-src/com/palantir/nexus/db/DataSourceStore.java
inoreabbr <buffer> logger logger=eclim#java#logging#LoggingInit("logger")
inoreabbr <buffer> log log=eclim#java#logging#LoggingInit("log")
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
edit pg/gotham/PGServer/server-src/com/palantir/nexus/db/SharedDataSourceBackend.java
inoreabbr <buffer> logger logger=eclim#java#logging#LoggingInit("logger")
inoreabbr <buffer> log log=eclim#java#logging#LoggingInit("log")
setlocal keymap=
setlocal noarabic
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 52 - ((9 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
...
wincmd w
argglobal
edit pg/gotham/PGServer/server-src/com/palantir/nexus/db/DataSourceBackend.java
inoreabbr <buffer> logger logger=eclim#java#logging#LoggingInit("logger")
inoreabbr <buffer> log log=eclim#java#logging#LoggingInit("log")
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
edit pg/gotham/PGServer/server-src/com/palantir/nexus/db/AbstractDataSourcePR.java
inoreabbr <buffer> logger logger=eclim#java#logging#LoggingInit("logger")
inoreabbr <buffer> log log=eclim#java#logging#LoggingInit("log")
setlocal keymap=
setlocal noarabic
