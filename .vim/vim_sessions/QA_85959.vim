...
set shortmess=aoO
badd +0 ~/Documents/pgdev/pg/gotham/PGServer/server-src/com/palantir/nexus/db/livereindex/LiveReindexPR.java
badd +0 pg/gotham/PGServer/server-src/com/palantir/util/reindex/LiveReindexStatusPrinter.java
badd +0 pg/gotham/PGServer/server-src/com/palantir/util/reindex/PdmFinishLiveReindexStatusPrinter.java
badd +0 pg/gotham/PGServer/server-src/com/palantir/nexus/db/livereindex/LiveReindexBackend.java
silent! argdel *
edit pg/gotham/PGServer/server-src/com/palantir/util/reindex/LiveReindexStatusPrinter.java
...
wincmd w
argglobal
edit pg/gotham/PGServer/server-src/com/palantir/util/reindex/PdmFinishLiveReindexStatusPrinter.java
inoreabbr <buffer> logger logger=eclim#java#logging#LoggingInit("logger")
inoreabbr <buffer> log log=eclim#java#logging#LoggingInit("log")
setlocal keymap=
setlocal noarabic
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 41 - ((39 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
41
...
wincmd w
argglobal
edit pg/gotham/PGServer/server-src/com/palantir/nexus/db/livereindex/LiveReindexBackend.java
inoreabbr <buffer> logger logger=eclim#java#logging#LoggingInit("logger")
inoreabbr <buffer> log log=eclim#java#logging#LoggingInit("log")
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
edit ~/Documents/pgdev/pg/gotham/PGServer/server-src/com/palantir/nexus/db/livereindex/LiveReindexPR.java
inoreabbr <buffer> logger logger=eclim#java#logging#LoggingInit("logger")
inoreabbr <buffer> log log=eclim#java#logging#LoggingInit("log")
setlocal keymap=
setlocal noarabic
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 314 - ((14 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
314
