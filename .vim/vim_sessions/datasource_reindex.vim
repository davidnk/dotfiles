...
set shortmess=aoO
badd +0 pg/gotham/PGServer/server-src/com/palantir/search/DatasourceReindexOps.java
badd +161 pg/gotham/PGServer/server-src/com/palantir/nexus/db/livereindex/LiveReindexFinisherImpl.java
badd +0 pg/gotham/PGServer/server-src/com/palantir/search/SearchNonincrementalReindexers.java
badd +0 pg/gotham/PGServer/server-src/com/palantir/search/TotalSearchNonincrementalReindexerImpl.java
silent! argdel *
edit pg/gotham/PGServer/server-src/com/palantir/search/DatasourceReindexOps.java
...
wincmd w
argglobal
edit pg/gotham/PGServer/server-src/com/palantir/nexus/db/livereindex/LiveReindexFinisherImpl.java
inoreabbr <buffer> logger logger=eclim#java#logging#LoggingInit("logger")
inoreabbr <buffer> log log=eclim#java#logging#LoggingInit("log")
setlocal keymap=
setlocal noarabic
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 161 - ((11 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
161
...
wincmd w
argglobal
edit pg/gotham/PGServer/server-src/com/palantir/search/SearchNonincrementalReindexers.java
inoreabbr <buffer> logger logger=eclim#java#logging#LoggingInit("logger")
inoreabbr <buffer> log log=eclim#java#logging#LoggingInit("log")
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
edit pg/gotham/PGServer/server-src/com/palantir/search/TotalSearchNonincrementalReindexerImpl.java
inoreabbr <buffer> logger logger=eclim#java#logging#LoggingInit("logger")
inoreabbr <buffer> log log=eclim#java#logging#LoggingInit("log")
setlocal keymap=
setlocal noarabic
